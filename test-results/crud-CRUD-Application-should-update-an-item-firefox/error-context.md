...
Locator: locator('#list tr').filter({ hasText: 'Original Item 1779030863748' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#list tr').filter({ hasText: 'Original Item 1779030863748' })
...
- table:
  ...
  - row "Original Item 1779030863085 Ändern Löschen":
    ...
    - cell "Löschen":
      - button "Löschen"
  - row "Original Item 1779030863748 Ändern Löschen":
    - cell "Original Item 1779030863748":
      - textbox: Original Item 1779030863748
    - cell "Ändern":
      - button "Ändern"
    - cell "Löschen":
      - button "Löschen"
